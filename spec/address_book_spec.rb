require_relative '../models/address_book'
 ...
 RSpec.describe AddressBook do
   ...
   describe "#import_from_csv" do
    ...
    #testing the data from entries__2.csv
    describe "#import_from_csv" do
       it "tests the csv import process" do
       ...
       it "imports the 1st entry" do
          book.import_from_csv("entries_2.csv")
          entry_one = book.entries[0]
          check_entry(entry_one, "Christine", "717-808-1220", "cnr1234@gmail.com")
       end

       it "imports the 2nd entry" do
         book.import_from_csv("entries_2.csv")
         entry_two = book.entries[1]
         check_entry(entry_two,"Kurt", "215-806-3409", "ktc1234@gmail.com")
       end

       it "imports the 3rd entry" do
         book.import_from_csv("entries_2.csv")
         entry_three = book.entries[2]
         check_entry(entry_three,"Todd", "215-806-8633", "toc5012@gmail.com")
       end
     end

  #testing the binary_search method
   ...
   #testing the iterative_search method
